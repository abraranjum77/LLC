...
<svg width="50" height="50" className="mobile-logo md:hidden" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        ...
        <Navbar.Toggle aria-expanded="false" aria-controls="responsive-navbar-nav" className="md:h-[80px] md:w-[80px] h-[50px] w-[50px] tri flex rounded-full items-center justify-center" >
