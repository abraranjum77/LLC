...
function Formtalktous() {
  ...
  return (
    <>
    <div className="talk_to_us relative md:py-[205px] py-[30px] md:my-[50px] my-[30px]">
    <Image
      alt="Talk to Us"
      src={Contact}
      placeholder="blur"
    ...
    <h2 className="text-[30px] md:text-[50px] text-[#fff] leading-[40px] md:leading-[72px] md:mb-[50px] mb-[30px]  font-bold">
  Talk To Us
</h2>
